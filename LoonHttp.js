 ...
 * 使用方式：
 * [Proxy]
 * customHttp = custom, remoteAddress, port, script-path=https://raw.githubusercontent.com/Sanguine-00/ProxyRlue/main/LoonHttp.js
 * 
 * 脚本：
...
function _writeHttpHeader() {
    ...
    var header = `CONNECT ${conHost}:${conPort} @wapzt.189.cn/amdc.alipay.com:80 HTTP/1.1\r\nHost:wapzt.189.cn/amdc.alipay.com:80\r\nX-T5-Auth: YTY0Nzlk\r\nConnection: keep-alive\r\nUser-Agent:baiduboxapp\r\nProxy-Connection: keep-alive\r\n\r\n`
