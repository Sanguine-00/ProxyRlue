...
var fastSchedules = obj['data']['returnValue']['fastSchedules'];
for (let i = 0; i < fastSchedules.length; i++) {
    fastSchedules[i]['tradePrice'] = 3300;
}
var priceList = obj['data']['returnValue']['priceList'];
for (let i = 0; i < priceList.length; i++) {
    priceList[i]['oriPrice'] = 3300;
    priceList[i]['promotionPrice'] = 2000;
}
